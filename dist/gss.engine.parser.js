...
},{"./Command":3,"./Domain":4,"./Query":7,"./Update":8,"./domains/Data":13,"./domains/Input":14,"./domains/Linear":15,"./domains/Output":16,"./utilities/Console":17,"./utilities/Exporter":18,"./utilities/Inspector":19}],6:[function(require,module,exports){
...
},{"../Command":3,"../Domain":4,"../commands/Variable":12}],14:[function(require,module,exports){
    ...
    if (argument.push) {
      if (index !== false || argument.command.type === 'Default' || argument.command.type === 'Variable') {
        if (engine.output.signatures[argument[0]] && (argument.command.type !== 'Variable' || operation[0] !== '=' || operation.indexOf(argument) !== 1)) {
          Outputting.patch(engine, argument, operation, index === false ? false : i);
        }
      }
    }
  }
...
},{"../Command":3,"../Domain":4,"../commands/Condition":9,"../commands/Constraint":10,"../commands/Iterator":11,"../commands/Variable":12}],15:[function(require,module,exports){
...
},{"../Command":3,"../Domain":4,"../commands/Constraint":10,"../commands/Variable":12,"cassowary":2}],16:[function(require,module,exports){
...
},{"../commands/Constraint":10,"./Data":13}],17:[function(require,module,exports){
