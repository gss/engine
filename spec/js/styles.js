...
describe('Styles', function() {
  ...
  describe('shorthand with no specific order of properties', function() {
    return it('should expand properties', function() {
      ...
      expect(doc['_background']('no-repeat', ['hsla', 3, 2, 1, 0], 'no-repeat')).to.eql(void 0);
      ...
      return expect(doc['_background']('top', 'right', 'padding-box', 'border-box', ['linear-gradient', ['to', 'top', 'right']])).to.eql(new doc['_background'].initial({
  ...
  describe('unordered shorthand with multiple values', function() {
    return it('should expand each value', function() {
      ...
      expect(doc['_background'](['no-repeat'], ['repeat'], 'transparent').toString()).to.eql('no-repeat, repeat transparent');
      ...
      return expect(doc['_background'](['no-repeat'], ['repeat'], 'transparent').toString({
  ...
  describe('ordered shorthand with multiple values', function() {
    return it('should do things', function() {
      ...
      expect(doc['_box-shadow']([1, 1, 'transparent'], [2, 2, ['rgba', 1, 1, 1]]).toString()).to.eql('1px 1px transparent, 2px 2px rgba(1,1,1)');
      ...
      return expect(doc['_box-shadow']([1, 1, 'transparent'], [2, 2, ['rgba', 1, 1, 1]]).toString({
  ...
  describe('ordered shorthands', function() {
    return it('should validate and expand value', function() {
      ...
      expect(doc['_border-left'](1, 'solid', 'tranceparent')).to.eql(void 0);
      expect(doc['_border-left'](1, 'zolid', ['rgb', 1, 1, 1])).to.eql(void 0);
      return expect(doc['_border-left'](['rgb', 1, 1, 1], ['em', 2])).to.eql(new doc['_border-left'].initial({
  ...
  describe('dimensional shorthands', function() {
    return it('should validate, pad and expand values', function() {
      ...
      return expect(doc['_border-style']('solid', 'dotted', 'double', 'ridge')).to.eql(new doc['_border-style'].initial({
        'border-top-style': 'solid',
  ...
  return xdescribe('transformations', function() {
    return it('should generate matrix', function() {
      ...
      return expect(doc['_transform']()).to.eql(123);
    });
  });
});
