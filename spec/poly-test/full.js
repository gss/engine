...
DEMOS.ADAPTIVE_ASPECT_LINEAR = DEMOS.ADAPTIVE_ASPECT.replace('::window[height]', '[height]').replace('::window[width]', '[width]').replace('@if', "[width] == ::window[width];\n[height] == ::window[height];\n@if");
