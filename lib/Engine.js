var Command, Engine, Get, Query, Setter, snatchProps,
...
Engine = (function() {
  ...
  Engine.prototype._handleMutations = function(mutations) {
    var gid, invalidMeasures, m, node, query, removedIds, removes, rid, selector, selectorsWithAdds, trigger, trigger_removes, trigger_removesFromContainer, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
    if (mutations == null) {
      mutations = [];
    }
    trigger = false;
  ...
  Engine.prototype.handleWorkerMessage = function(message) {
    this.unobserve();
    snatchProps(message.data.values, this.vars);
