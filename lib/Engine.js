...
Engine = (function() {
  function Engine(o) {
    ...
    this.onEditableStyleInput = __bind(this.onEditableStyleInput, this);
    this.execute = __bind(this.execute, this);
    this.container = o.container, this.workerURL = o.workerURL, this.vars = o.vars, this.getter = o.getter, this.setter = o.setter;
    if (!this.vars) {
      this.vars = {};
    }
    if (!this.container) {
  ...
  */
  ...
  Engine.prototype.setupCSSDumpIfNeeded = function() {
    if (!this.cssDump) {
      ...
      return this.container.appendChild(this.cssDump);
    }
  };
  ...
  Engine.prototype.loadAndRun = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (node.isContentEditable && !node._isFixingSelfFromBullShit) {
        node._isFixingSelfFromBullShit = true;
        node.addEventListener("input", this.onEditableStyleInput);
      }
    }
    this.run(ASTs);
    return this;
  ...
  Engine.prototype.onEditableStyleInput = function(e) {
    this.unobserve();
