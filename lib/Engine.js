...
Engine = (function() {
  function Engine(workerPath, container) {
    ...
    this.observer = new MutationObserver(function(mutations) {
      var addsBySelector, gid, m, node, query, removedIds, removesBySelector, removesFromContainer, rid, selector, selectorsWithAdds, trigger, trigger_addsToSelectors, trigger_removesBySelector, trigger_removesFromContainer, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
      trigger = false;
          ...
          if (query.lastRemovedIds.length > 0) {
            ...
            if (trigger_removesFromContainer) {
              ...
              for (_k = 0, _len2 = removedIds.length; _k < _len2; _k++) {
                rid = removedIds[_k];
                if (removesFromContainer.indexOf(rid) === -1) {
      ...
      */
      ...
      if (trigger_removesFromContainer) {
        _this.commander.handleRemovesFromContainer(removesFromContainer);
      }
