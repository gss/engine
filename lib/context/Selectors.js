...
Selectors = (function() {
  ...
  Selectors.prototype.onDOMQuery = function(engine, scope, args, result, operation, continuation, subscope) {
    return this.engine.queries.filter(scope || operation.func && args[0], result, operation, continuation, subscope);
  };
