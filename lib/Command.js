...
var Command, bindCache, bindRoot, checkCache, makeTemplateFromVarId, _templateVarIdCache,
...
Command = (function() {
  ...
  Command.prototype.handleSelectorsWithAdds = function(selectorsWithAdds) {
  ...
  Command.prototype.handleInvalidMeasures = function(invalidMeasures) {
  ...
  Command.prototype.spawnIntrinsicSuggests = function(root) {
    var prop,
      _this = this;
        ...
        root._intrinsicQuery.lastAddedIds.forEach(function(id) {
          ...
          if (!_this.intrinsicRegistersById[gid][prop]) {
            register = function() {
              ...
              return this.engine.registerCommand(['suggest', ['get', "" + gid + "[" + prop + "]"], ['number', val]]);
            };
