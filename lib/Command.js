...
Command = (function() {
  ...
  Command.prototype.handleRemovesFromContainer = function(removesFromContainer) {
    var command, id, _i, _len;
    command = ['remove'];
    for (_i = 0, _len = removesFromContainer.length; _i < _len; _i++) {
      id = removesFromContainer[_i];
      command.push("$" + id);
    }
