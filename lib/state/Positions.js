...
Positions = (function() {
  ...
  Positions.prototype.pull = function(data) {
    ...
    this.data = data;
    if (suggestions = this.engine.measurements.flush()) {
  ...
  Positions.prototype.push = function(data) {
  ...
  Positions.prototype.get = function(path, property, value) {
  ...
  Positions.prototype.set = function(id, property, value, positioning, intrinsic) {
