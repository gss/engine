...
Commander = (function() {
  ...
  Commander.prototype.spawnForWindowWidth = function() {
    ...
    if (this.engine.vars["::window[width]"] !== w) {
      return this.engine.registerCommand(['suggest', ['get', "::window[width]"], ['number', w], 'strong', 1000]);
    }
  };
  ...
  Commander.prototype.spawnForWindowHeight = function() {
    ...
    if (this.engine.vars["::window[height]"] !== h) {
      return this.engine.registerCommand(['suggest', ['get', "::window[height]"], ['number', h], 'strong', 1000]);
    }
  };
        ...
        root._intrinsicQuery.lastAddedIds.forEach(function(id) {
          ...
          if (!_this.intrinsicRegistersById[gid][prop]) {
            register = function() {
              ...
              return this.engine.registerCommand(['suggest', ['get', "" + gid + "[" + prop + "]"], ['number', val], 'strong', 1000]);
            };
