...
Commander = (function() {
  ...
  Commander.prototype.spawn = function(node) {
    var contextQuery, context_id, q, queries, ready, rule, _i, _j, _len, _len1, _ref, _results;
    ...
    if (ready) {
      ...
      if (node.isContextBound) {
        ...
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          context_id = _ref[_j];
          _results.push(this.installCommandFromBase(node, context_id));
        }
        return _results;
      } else {
        return this.installCommandFromBase(node);
      }
    }
    /* TODO
  ...
  Commander.prototype['get$'] = function(root, prop, query) {
    ...
    if (!val) {
      val = this._get$(root, prop, query);
      this.get$cache[key] = val;
    }
    return val;
  };

  Commander.prototype['_get$'] = function(root, prop, query) {
  ...
  Commander.prototype['$class'] = function(root, sel) {
    var query, selector,
      _this = this;
    selector = "." + sel;
    query = this.engine.getDomQuery(selector);
    if (!query) {
