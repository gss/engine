...
Update.prototype = {
  ...
  merge: function(from, to) {
    ...
    console.error('merge', this.problems[from].slice(), this.problems[to].slice(), 'removed', domain.constraints.slice(), '->', other.constraints.slice(), this.index, from, to, this.problems[to].length);
  ...
  connect: function() {
    var breaking, connected, domain, framed, i, j, other, problems, variable, variables, vars, _i, _j, _len, _ref, _ref1, _ref2;
    connected = breaking = void 0;
    i = this.domains.length;
    while (domain = this.domains[--i]) {
      if (i === this.index) {
        break;
      }
