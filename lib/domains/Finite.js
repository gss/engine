var Command, Constraint, Domain, Finite, Value,
...
Finite.Value.Variable = Command.extend.call(Value.Variable, {
  group: 'finite'
});

Finite.Value.Expression = Command.extend.call(Value.Expression, {
  group: 'finite'
}, {
  '+': function(left, right) {
