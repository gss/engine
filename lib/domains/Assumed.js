...
Assumed = (function(_super) {
  __extends(Assumed, _super);

  Assumed.prototype.priority = 0;

  function Assumed() {
    this._observers = {};
    this._watchers = {};
    Assumed.__super__.constructor.apply(this, arguments);
  }

  Assumed.prototype.watch = function(id, property, operation, continuation, scope) {
  ...
  Assumed.prototype.unwatch = function(id, property, operation, continuation, scope) {
  ...
  Assumed.prototype.remove = function(continuation) {
  ...
  Assumed.prototype.get = function(id, property) {
    return this[this.getPath(id, property)];
  };

  Assumed.prototype.solve = function(reason, key, value) {
  ...
  Assumed.prototype.toObject = function() {
