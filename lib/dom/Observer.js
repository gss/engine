...
Observer = (function() {
    ...
    if (old && old.length) {
      ...
      for (_i = 0, _len = old.length; _i < _len; _i++) {
        ...
        if (!result || old.indexOf.call(result, child) === -1) {
          this.object.references.remove(path, child);
          removed = true;
        }
      }
      if (continuation && (!isCollection || !result.length)) {
        this.object.references.remove(continuation, path);
      }
    }
    if (isCollection) {
      added = void 0;
      for (_j = 0, _len1 = result.length; _j < _len1; _j++) {
        ...
        if (!old || watchers.indexOf.call(old, child) === -1) {
          this.object.references.append(path, child);
          if (old) {
  ...
  Observer.prototype.listen = function(mutations) {
    ...
    this.object.engine.setNeedsUpdate(true);
